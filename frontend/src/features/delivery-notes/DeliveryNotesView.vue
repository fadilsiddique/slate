<template>
  <div class="flex flex-col min-h-full">
    ...
    <div class="flex-1 px-4 py-3">
      ...
      <!-- Error state -->
      <ErrorState v-else-if="error" title="Couldn't load delivery notes" :message="error" @retry="reload(true)" />
    ...
    <FloatingActionButton @click="router.push({ name: 'DeliveryNoteNew' })" />
  </div>
</template>
